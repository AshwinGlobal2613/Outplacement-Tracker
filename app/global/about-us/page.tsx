...
import {
  ...
  RefreshCw, Heart, Smile, Zap, Star, Shield, TrendingUp,
  MapPin, ChevronDown,
} from 'lucide-react'
    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72 }}>
        <a href="/global" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 8, background: `linear-gradient(135deg, ${C.rose}, ${C.coral})`, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: `0 0 16px rgba(190,55,88,0.5)` }}>
            <Globe2 size={18} color="#fff" />
          </div>
          <span style={{ fontWeight: 800, fontSize: 20, letterSpacing: 3, background: `linear-gradient(90deg, ${C.white}, ${C.gold})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>GLOBAL</span>
        </a>
    ...
    <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden', padding: '120px 5% 80px' }}>
      ...
      <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          <a href="#values" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 32px', borderRadius: 50, background: `linear-gradient(135deg, ${C.rose}, ${C.coral})`, color: '#fff', fontSize: 14, fontWeight: 700, textDecoration: 'none', letterSpacing: 0.5, boxShadow: `0 4px 24px rgba(190,55,88,0.45)` }}>
            OUR VALUES <ArrowRight size={16} />
          </a>
          <a href="#presence" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 32px', borderRadius: 50, background: 'rgba(255,255,255,0.07)', backdropFilter: 'blur(12px)', border: `1px solid rgba(255,255,255,0.18)`, color: C.white, fontSize: 14, fontWeight: 700, textDecoration: 'none', letterSpacing: 0.5 }}>
            OUR PRESENCE <MapPin size={16} />
          </a>
        </div>
      </div>
    </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 60, alignItems: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
              ...
              { value: '220+', label: 'Happy Clients' },
              { value: '85%', label: 'Repeat & Referral' },
            ].map(s => (
              <div key={s.label} style={{ background: C.card, backdropFilter: 'blur(12px)', border: '1px solid rgba(156,136,155,0.15)', borderRadius: 16, padding: '28px 22px', textAlign: 'center' }}>
                <div style={{ fontSize: 36, fontWeight: 800, background: `linear-gradient(135deg, ${C.rose}, ${C.coral})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: 6 }}>{s.value}</div>
                <div style={{ color: C.mauve, fontSize: 13, fontWeight: 500, letterSpacing: 0.5 }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
...
function ValueCard({ v, index }: { v: typeof VALUES[number]; index: number }) {
  ...
  return (
    <div style={{ perspective: '900px', width: 'clamp(220px, calc(25% - 15px), 268px)', flexShrink: 0 }}>
      <div
        ref={cardRef}
      ...
      >
        ...
        <div style={{
          ...
          background: hov ? `${v.accent}22` : `${v.accent}10`,
          border: `1px solid ${v.accent}${hov ? '55' : '1a'}`,
          ...
          <v.Icon size={22} color={v.accent} strokeWidth={hov ? 2.2 : 1.8} />
        </div>
...
function Footer() {
  return (
    <footer style={{ padding: '52px 5% 32px', background: '#080610', borderTop: '1px solid rgba(156,136,155,0.12)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 24, marginBottom: 48 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, background: `linear-gradient(135deg, ${C.rose}, ${C.coral})`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Globe2 size={18} color="#fff" />
            </div>
            <span style={{ fontWeight: 800, fontSize: 18, letterSpacing: 3, background: `linear-gradient(90deg, ${C.white}, ${C.gold})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>GLOBAL</span>
          </div>
          ...
          <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap' }}>
            {[
              ...
              <a key={label} href={href} style={{ color: C.mauve, fontSize: 13, textDecoration: 'none', fontWeight: 500, transition: 'color 0.2s' }}
                onMouseEnter={e => (e.currentTarget.style.color = C.white)}
          ...
          <a href="#" style={{ width: 38, height: 38, borderRadius: 10, background: 'rgba(51,42,63,0.6)', border: '1px solid rgba(156,136,155,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: C.mauve, textDecoration: 'none', transition: 'border-color 0.2s, color 0.2s' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = C.rose; e.currentTarget.style.color = C.white }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(156,136,155,0.2)'; e.currentTarget.style.color = C.mauve }}
          >
            <Linkedin size={16} />
          </a>
        </div>

        <div style={{ borderTop: '1px solid rgba(156,136,155,0.1)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <p style={{ color: C.mauve, fontSize: 13, margin: 0, opacity: 0.6 }}>© {new Date().getFullYear()} Global Management Consultant. All rights reserved.</p>
          <p style={{ color: C.mauve, fontSize: 13, margin: 0, opacity: 0.6 }}>The Business Design Company</p>
        </div>
      </div>
    </footer>
  )
